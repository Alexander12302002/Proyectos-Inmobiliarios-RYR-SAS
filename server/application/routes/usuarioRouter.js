...
const UserController = require("../controllers/usuarioController"); // Importing the UserController
const UserValidator = require("../validator/usuarioValidator"); // Importing the UserValidator
